...
<p align="center">
  ...
  <h1 align="center">Sub-Currency Smart Contract</h1>
  <p align="center">
    Blockchain
    <br />
...
This smart contract creates a crypto-currency which is can be minted only by the creator of the currency, with a maximum of coins to be minted. It also allows to send crypto-currencies from one account to another. :smile:
...
1. Clone the repo
   ...
   ```
   ```sh
   git clone git@github.com:darubiomunoz/smartcontract-subcurrency.git
   ```
...
Project Link: [https://github.com/darubiomunoz/smartcontract-subcurrency.git](https://github.com/darubiomunoz/smartcontract-subcurrency.git)
